...
} = require("../validations/userCreationValidations");
...
const signinController = async (req, res) => {
  try {
    ...
    const userDetails = { user: { email:email, name:name, password:savedUser.password } };
    const isAdmin = await requireAdmin(userDetails);
